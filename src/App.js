...
const CHAPTERS = [
  ...
  { id: "primitives", title: "Primitives & Éq. diff.", icon: "∫'", color: "#fb923c", theme: "Analyse", metLink: `${BASE}#8`, coursePdf: [`${T}20Prim-EdT.pdf`], courseVideo: "https://youtu.be/bQ-eS1zZCdw",
    ...
    exerciseVideos: [{ title: "BAC Éq. diff, expo, suites", url: "https://youtu.be/VMRsAkKAVZo" }],
      ...
      { name: "Lycée d'Adultes — Tableau des primitives", url: "https://www.lyceedadultes.fr/sitepedagogique/documents/math/mathTermSpe/07_primitives-eq_diff/07_tableau_primitives.pdf", icon: "" },
...
{name:"Primitives & Intégration",ids:["primitives","integration"],qs:[60,61,62,63,64,65,66,67,68,69]},
{name:"Combinatoire & Probabilités",ids:["combinatoire","probabilites"],qs:[70,71,72,73,74,75,76,77,78,79]},
{name:"Géométrie dans l'espace",ids:["geometrie"],qs:[80,81,82,83,84,85,86,87,88,89]},
{name:"Nombres complexes",ids:["complexes"],qs:[90,91,92,93,94,95,96,97,98,99]}
];
// ─── APP ────────────────────────────────────────────────────
